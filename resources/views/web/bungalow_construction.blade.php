  ...
  <div class="bg-white rounded-xl shadow-lg p-8">
    ...
    $methods = [
      [
        ...
        'desc' => 'As a trusted <strong>bungalow contractor in Khopoli and Karjat,</strong> we specialize in personalized home construction that combines Vastu-compliant layouts with durable RCC work. Whether youre building a farmhouse or a luxury villa, we offer complete support — from planning to finishing.',
