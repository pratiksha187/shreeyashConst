...
<div class="max-w-8xl">
  <div class="bg-white rounded-xl shadow-lg p-8">
    ...
    $methods = [
      [
        'title' => 'Fencing Work',
        'desc' => 'We offer fencing contractor services in Maharashtra for barbed wire, chain-link, or MS angle fencing. This is suitable for land demarcation, industrial sites, and temporary enclosures. Our fencing solutions are fast to deploy and built to last.',
