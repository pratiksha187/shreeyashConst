  ...
  <div class="bg-white rounded-xl shadow-lg p-8">
    ...
    $methods = [
      [
        ...
        'desc' => 'As a reputed <strong>storm water drain contractor,</strong> we specialize in designing and 
                    constructing RCC and precast drainage systems that efficiently manage monsoon runoff. 
                    Our <strong>SWD work in Maharashtra</strong> includes open drains, box culverts, and proper slope 
                    management to prevent urban waterlogging.',
        'img' =>  asset('storage/logo/main/d1.png'),
      ],
    ];
    @endphp
