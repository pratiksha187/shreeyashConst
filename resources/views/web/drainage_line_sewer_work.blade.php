  ...
  <div class="bg-white rounded-xl shadow-lg p-8">
    ...
    $methods = [
      [
        ...
        'desc' => 'Shreeyash Construction offers expert services for <strong>drainage pipeline contractors</strong> and sewer line installations using RCC, PVC, and HDPE pipes. As a trusted <strong>sewer civil contractor,</strong> we ensure proper slope, joint sealing, and manhole chamber integration for long-term functionality.',
