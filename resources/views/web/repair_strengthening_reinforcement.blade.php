  ...
  <div class="bg-white rounded-xl shadow-lg p-8">
    ...
    $methods = [
      [
        ...
        'desc' => 'We carry out <strong>structural repair and strengthening services</strong> for aging or damaged factory structures. Our team serves industries in <strong>Mahad, Chakan, and Dhatav MIDCs,</strong> providing epoxy grouting, steel anchoring, and RCC reinforcement as per audit or consultant guidelines.',
