...
Route::get('/underground-water-supply', [HomeController::class, 'underground_water_supply'])->name('underground_water_supply');

Route::get('/drainage-line-sewer-work', [HomeController::class, 'drainage_line_sewer_work'])->name('drainage_line_sewer_work');

Route::get('/rcc_chamber_installation', [HomeController::class, 'rcc_chamber_installation'])->name('rcc_chamber_installation');
Route::get('/precast-U-Drain-Installation-Services', [HomeController::class, 'precast_u_drain'])->name('precast_u_drain');
...
Route::get('/precast-compound-walls', [HomeController::class, 'precast_compound_walls'])->name('precast_compound_walls');
Route::get('/fencing-work', [HomeController::class, 'fencing_work'])->name('fencing_work');

Route::get('/compound-wall', [HomeController::class, 'compound_wall'])->name('compound_wall');
Route::get('/residencial-commercial', [HomeController::class, 'residencial_commercial'])->name('residencial_commercial');
Route::get('/bungalow-construction', [HomeController::class, 'bungalow_construction'])->name('bungalow_construction');

Route::get('/commercial-unit-civil-work', [HomeController::class, 'commercial_unit_civil_work'])->name('commercial_unit_civil_work');
Route::get('/retrofiting-demolition', [HomeController::class, 'retrofiting_demolition'])->name('retrofiting_demolition');

Route::get('/structural-retrofitting', [HomeController::class, 'structural_modification'])->name('structural_modification');
...
Route::get('/demolition-work', [HomeController::class, 'demolition_work'])->name('demolition_work');
